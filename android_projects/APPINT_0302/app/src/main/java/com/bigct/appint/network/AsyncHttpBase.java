...
public class AsyncHttpBase extends AsyncTask<String, Integer, String> {
	...
	protected IAsyncHttpResponseListener listener;
	 ...
	 * @param parameters
	 */
	public AsyncHttpBase(Context context, IAsyncHttpResponseListener listener, List<NameValuePair> parameters, boolean isShowWatingDilog) {
	...
	public AsyncHttpBase(Context context, IAsyncHttpResponseListener listener, String json, boolean isShowWatingDilog) {
		this.context = context;
		this.listener = listener;
	...
	protected void onPostExecute(String result) {
		...
		listener.after(statusCode, jsonResponse);
	}
