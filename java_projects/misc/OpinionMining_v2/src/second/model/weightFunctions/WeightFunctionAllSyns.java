...
public class WeightFunctionAllSyns extends WeightFunction {
	
	/*
	 * Class implements case d-b. 
	 * It searches for the word, it's synonyms and it's meronyms.
	 * To find words does an intersections of their synonyms.
	 * 
	 * BAD - it will provide way too many references
	 */
