...
public class OvalSnapModel extends SnapModel
{
	public OvalSnapModel(IReadablePoint position) {
		this(position.x(), position.y());
	}
	public OvalSnapModel(double x, double y) {
		super(x, y, 100, 50, true, MColor.PINK, MColor.GREEN, MColor.RED);
