...
//                 label.wordWrap = grid.columnHeaderWordWrap(grid.columns[listData.columnIndex]);
                                                  ...
                                                  unscaledHeight:Number):void
    {
		...
		labelWidth	= maxLabelWidth; /* Michael - Make the field take up the entire box. */ 
		label.width	= labelWidth;
		
        // Adjust to given height
        var labelHeight:Number = label.textHeight + (UITextField.TEXT_HEIGHT_PADDING * label.numLines);
